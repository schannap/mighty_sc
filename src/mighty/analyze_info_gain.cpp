...
{
public:
    OcclusionAnalysisNode() : Node("occlusion_analysis_node")
    {
        ...
        // Parameters to create the mighty object
        // ---------------- Vehicle / mode ----------------
        ...
        // Set the parameters for mighty object
        ...
        sync_->registerCallback(
            std::bind(&OcclusionAnalysisNode::mapCallback,
                      this,
                      std::placeholders::_1,
                      std::placeholders::_2));
...
int main(int argc, char **argv)
{
    ...
    rclcpp::spin(std::make_shared<OcclusionAnalysisNode>());
    rclcpp::shutdown();
    return 0;
}
